...
#### Инженерный проект по развёртыванию и настройке инфраструктуры сбора, преобразования и визуализации данных для интернет-магазина. 

Основная цель проекта — построение полноценного конвейера данных, обеспечивающего разделение операционной (OLTP) и аналитической (OLAP) нагрузки.
